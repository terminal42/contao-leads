...
$GLOBALS['TL_LANG']['tl_lead_export']['onlyExportSinceLastExportDate'] = array('Only export new lead data since last export date', 'Please select if only new lead data since last export date should be exportet.');
$GLOBALS['TL_LANG']['tl_lead_export']['lastExportDate']                = array('Last export date', 'Please enter the last export date. The value is automatically changed when this option is enabled.');
